...
def P3():
    root = Tk()
    root.title("P3 Grades")
    root.geometry("1080x1000")
    #========================================================================FRAME FOR THE TITLE================================================================================
    frame_student = Label(root, text=f"P3 GRADES", font=("Helvitica", 20, 'bold'), width=20,bg='#333333', fg='white' ,bd=40,borderwidth=30, relief=RIDGE, padx=930)
    frame_student.grid(row=0, column=1,  sticky=W)
    

    #=========================================================================P3 RECORDS=======================================================================================
    frame_for_P3 = Frame(root, bg='#333333',bd=40,borderwidth=30, relief=RIDGE,)
    label_for_P3=Label(frame_for_P3, text="P3 RECORDS", font=("Helvitica", 20, 'bold'), width=20,bg='#333333', fg='white' ,bd=40,borderwidth=30, relief=RIDGE, padx=730)
    label_for_P3.pack(anchor=CENTER)
    frame_for_P3.place(x=0, y=100, width=1000, height=900)
   ...
   #===========================================================================SEARCH BUTTON FUNCTION=========================================================================
    ...
    #========================================================================BACK BUTTON===================================================================================
    back_button = Button(frame_for_P3, font=('calibri', 15, 'bold'), bg='green', 
                            fg='white', 
                            bd=0,
                            pady=0, 
                            activeforeground='white', 
    ...
    #==============================================================================SCROLLBARS==========================================================================
    scrollX = Scrollbar(frame_for_P3, orient='horizontal', bg='#333333')
    scrollX.pack(side='bottom', fill=X)

    scrollY = Scrollbar(frame_for_P3, orient='vertical')
    scrollY.pack(side='right', fill=Y)



    #=============================================================================P1 DISPLAY RECORDS============================================================================
    columns = ('student id', 'P3 GRADE', 'activities', 'exam', 'quizzes', 'number of absentees')
    display = ttk.Treeview(frame_for_P3, show='headings', columns=columns,  xscrollcommand=scrollX.set, yscrollcommand=scrollY.set)
    ...
    display.heading('number of absentees', text='Number of Absentees')

    display.column('student id', width=100, anchor='center')
    display.column('P3 GRADE',  width=100, anchor='center')

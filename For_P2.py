...
def P2():
    ...
    #========================================================================FRAME FOR THE TITLE================================================================================
    frame_student = Label(root, text=f"P2 GRADES", font=("Helvitica", 20, 'bold'), width=20,bg='#333333', fg='white' ,bd=40,borderwidth=30, relief=RIDGE, padx=930)
    frame_student.grid(row=0, column=1,  sticky=W)
    

    #=========================================================================P1 RECORDS=======================================================================================
    frame_for_P2 = Frame(root, bg='#333333',bd=40,borderwidth=30, relief=RIDGE,)
    label_for_P2=Label(frame_for_P2, text="P2 RECORDS", font=("Helvitica", 20, 'bold'), width=20,bg='#333333', fg='white' ,bd=40,borderwidth=30, relief=RIDGE, padx=730)
    label_for_P2.pack(anchor=CENTER)
    frame_for_P2.place(x=0, y=100, width=1000, height=900)
   ...
   #===========================================================================SEARCH BUTTON FUNCTION=========================================================================
    ...
    def back_button_function():
       ...
       student_table.init()
    #========================================================================BACK BUTTON===================================================================================
    back_button = Button(frame_for_P2, font=('calibri', 15, 'bold'), bg='green', 
                            fg='white', 
                            bd=0,
                            pady=0, 
                            activeforeground='white', 
    ...
    #==============================================================================SCROLLBARS==========================================================================
    scrollX = Scrollbar(frame_for_P2, orient='horizontal', bg='#333333')
    scrollX.pack(side='bottom', fill=X)

    scrollY = Scrollbar(frame_for_P2, orient='vertical')
    scrollY.pack(side='right', fill=Y)



    #=============================================================================P1 DISPLAY RECORDS============================================================================
    columns = ('student id', 'P2 GRADE', 'activities', 'exam', 'quizzes', 'number of presents')
    display = ttk.Treeview(frame_for_P2, show='headings', columns=columns,  xscrollcommand=scrollX.set, yscrollcommand=scrollY.set)
    display.heading('student id', text='Student ID')
    display.heading('P2 GRADE', text='P1 Grade')
    ...
    display.column('P2 GRADE',  width=100, anchor='center')

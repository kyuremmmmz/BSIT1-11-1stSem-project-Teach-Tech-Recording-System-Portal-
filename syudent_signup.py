...
connect =mysql.connector.connect(host='localhost', user= 'root', password= 'admin', database= 'for_student_signup')
...
def registration_form():
    ...
    def registration_save():
        ...
        myquery = "INSERT INTO for_student_signup(student_id, num, u_name, l_name, m_name, g_name, pass) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    ...
    #===================================================================PUNTA SA SIGNUP===================================================================================
        try:
            ...
            student_table.init()  # Call the init function from the login form
    ...
    bg_image = Image.open('FOR REG.jpg')
    bg_photo = ImageTk.PhotoImage(bg_image)

# Create a label with the image and place it in the window
    for_label_bg = Label(root, image=bg_photo)
    for_label_bg.place(relwidth=1, relheight=1)
    for_label_bg.place(relheight=1, relwidth=1) 
    root.title("Sign-up")

    # Create a frame for the registration form
    registration = LabelFrame(root, text="Sign-up form for student", font=("Helvetica", 18, 'bold'), border=0, bg='#333333', fg='white')
